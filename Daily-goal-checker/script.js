    ...
    function handleAddGoal() {
        ...
        const priority = prioritySelect.value.trim();      // TODO: replace empty string with real value
        ...
        if(goalText.trim()==="")
        {
            alert("please Fill the Goal title");
            return;
        }
        ...
        li.setAttribute("class","goal-item")
        ...
        mainDiv.setAttribute("class","goal-main"); // TODO

        // TODO: Create a span for goal title (class "goal-title")
        const titleSpan = document.createElement("span");
        titleSpan.setAttribute("class","goal-title"); // TODO
        ...
        tagSpan.textContent =priority.charAt(0).toLowerCase() + priority.slice(1); 
        ...
        if(priority==="high")
        {
        tagSpan.setAttribute("class","goal-tag goal-tag--high");
        }
        else if(priority==="medium")
        {
        tagSpan.setAttribute("class","goal-tag goal-tag--medium");
        }
        else{
        tagSpan.setAttribute("class","goal-tag goal-tag--low");        
        }
    ...
    mainDiv.appendChild(titleSpan);
        ...
        actionsDiv.setAttribute("class","goal-actions");
        // TODO: Create "Done" button, add class "goal-btn" and "done-btn"
        const doneBtn = document.createElement("button");
        doneBtn.setAttribute("class","goal-btn"); // TODO
        ...
        deleteBtn.setAttribute("class","goal-btn"); // TODO
        ...
        doneBtn.addEventListener("click",()=>{
            // let parentLi = doneBtn.parentElement;
            // goalList.removeChild(parentLi);
